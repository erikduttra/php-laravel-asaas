...
<html lang="pt-br">
    ...
    <body>
        ...
        <form action="{{ url('admin/produto/'.$produto->id) }}" method="post">
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="valr_produto" placeholder="R$ 0,00" name="valr_produto" value="{{ number_format($produto->valr_produto, 2) }}">
            </div>
            <div class="form-group">
